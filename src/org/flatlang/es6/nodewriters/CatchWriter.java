...
import org.flatlang.tree.exceptionhandling.Catch;
...
public abstract class CatchWriter extends ExceptionHandlerWriter
{
	...
	public StringBuilder write(StringBuilder builder)
	{
		...
		ClassDeclarationWriter classWriter = getWriter(node().getProgram().getClassDeclaration("flatlang/exception/Exception"));
